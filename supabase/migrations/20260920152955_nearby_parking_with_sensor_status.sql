...
create function public.nearby_parking(p_lat double precision, p_lng double precision, p_radius_m integer default 1000)
 returns table(id uuid, address_text text, suburb text, state text, country text, lat double precision, lng double precision, distance_m double precision, created_by uuid, photo_url text, moderation_status text, rules json, latest_ping json, sensor_status json)
 language sql
 stable
